...
public class Tables {
    public static void main(String[] args){
        try{
            ...
            String Ticket = "create table ticket(id int primary key,name varchar(200),mobileno varchar(10),email varchar(200),date varchar(50),total varchar(200),createdBy varchar(200),source varchar(200),destination varchar(200))";
            String Enterprise = "create table enterprise(id int AUTO_INCREMENT primary key, name varchar(200), password varchar(200))";
            ...
            DbOperations.setDataorDelete(Ticket, "Ticket Table created Successfully");
            DbOperations.setDataorDelete(Enterprise, "Enterprise Table created Successfully" );
        }
        catch(Exception e){
